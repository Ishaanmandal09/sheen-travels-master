...
const webImages = [
  'https://images.unsplash.com/photo-1565552643952-b4b159f81216?auto=format&fit=crop&q=80&w=900',
  'https://images.unsplash.com/photo-1591604129939-f1efa4d9f7fa?auto=format&fit=crop&q=80&w=900',
  'https://images.unsplash.com/photo-1580281691888-c7a31b67f10b?auto=format&fit=crop&q=80&w=900',
  'https://images.unsplash.com/photo-1541291887-8bc100e47087?auto=format&fit=crop&q=80&w=900',
  'https://source.unsplash.com/900x600/?makkah,kaaba',
  'https://source.unsplash.com/900x600/?madinah,mosque',
  'https://source.unsplash.com/900x600/?masjid,nabawi'
];

const fallbackPackages = [
  {
    _id: '1',
    title: 'Premium Umrah 2026',
    type: 'Umrah',
    price: '110000',
    ...
    <div style={{ backgroundColor: 'var(--light-bg)', minHeight: '100vh' }}>
      ...
      <nav className="navbar" style={{ padding: '10px 5%' }}>
        ...
        <Link
          ...
          style={{
            ...
            border: '2px solid var(--sheen-green)'
          }}
        >
          Back to Home
        </Link>
      ...
      >
        ...
        <p style={{ fontSize: '1.1rem', opacity: '0.9' }}>
          Find the perfect journey for your soul
        </p>
      </div>
                ...
                filteredPackages.map((pkg) => (
                  <div key={pkg._id} className="package-card">
                    ...
                    <div className="package-info">
                      ...
                      <p style={{ color: '#777', fontSize: '0.95rem', marginBottom: '10px' }}>
                        🕒 {pkg.duration}
                      </p>
                      ...
                      <Link to={`/package/${pkg._id}`} className="book-btn">
                        View Details
                      </Link>
                    </div>
                  </div>
